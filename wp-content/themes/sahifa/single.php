	...
	<div class="content">
		...
		<article <?php if( !empty( $rv['review'] ) ) echo $rv['review']; post_class('post-listing'); ?>>
			...
			<div class="post-inner">
				...
				<div style="display:none" class="vcard author" itemprop="author" itemscope itemtype="http://schema.org/Person"><strong class="fn" itemprop="name"><a href="<?php the_author_meta( 'google' ); ?>/about?rel=author">+<?php echo get_the_author(); ?></a></strong></div>
				<?php }else{ ?>
